...
public class FeedForwardLayer implements Layer<double[], double[]>, Learnable {
    ...
    public FeedForwardLayer(AffineLayer fc1, ActivationFunction activationFunction, AffineLayer fc2){
        this.fc1 = fc1;
        this.act = new ActivationLayerAdapter(activationFunction);
        this.fc2 = fc2;
    }

    public FeedForwardLayer(int modelDim, int hiddenDim, ActivationFunction activationFunction) {
